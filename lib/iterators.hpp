...
class ContainerIterator {
   ...
   public:
    ...
    ContainerIterator(buffer_type* buffer, size_type index) : buffer_(buffer), index_(index){}

    ContainerIterator(const ContainerIterator<T, Extendable, Allocator, false>& other): buffer_(other.buffer_), index_(other.index_){};
    ...
    ContainerIterator operator-(difference_type n) const;
    difference_type operator-(const ContainerIterator<T,Extendable, Allocator, true>& other) const;
...
template <typename T, bool Extendable, typename Allocator, bool isConst>
auto CntnrIterator::operator-(const ContainerIterator<T,Extendable, Allocator, true>& other) const -> difference_type{
